...
#%%
meta_labels_train = meta_labels[:"2022-05-12"]
meta_labels_oos   = meta_labels["2022-05-14":]
...
#%%
parameters = {'max_depth':[4, 5, 7, 15, 20, 30],
              'n_estimators':[10, 25, 50, 100, 256, 512, 1000]}
...
#%%
selected_cmda_features = ['ULTOSC', 'm_wr_12', 't_macd_800_400', 'vm_cmf_50', 'vm_fi_120', 'ma_12']

#%%
# parameter search for f1

parameters = {
    'max_depth': [4, 5, 7, 15, 20, 30],
    'n_estimators':[10, 25, 50, 100, 256, 512, 1000]
    }
...
#%%
eval_df = df["2022-05-16":][eval_features].copy()
eval_df
...
joblib.dump(rf_meta, "../model/btcusdt_rf_meta.save")

#%%
features_string = " ".join(selected_cmda_features)
print(features_string)

with open("../model/features_meta.txt", "w") as f:
    f.write(features_string)


#%%
loaded_rf = joblib.load("../model/btcusdt_rf_meta.save")
